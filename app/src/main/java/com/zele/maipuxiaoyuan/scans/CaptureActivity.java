package com.zele.maipuxiaoyuan.scans;
 ...
 * 条码二维码扫描功能实现
 */
public class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback, android.view.View.OnClickListener {
...
//		initEvent();
	...
	private void initView() {
		mbutton_back= findViewById(R.id.mbutton_back);
...
//		qrcode.setBackgroundResource(R.drawable.scan_qr_hl);
		statusView.setText("将二维码放入框内，即可自动扫描");
...
//		setScanType();
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		//decodeDate---17/3/27 11:24
		//metadataText--H
		//resultString--http://weixin.qq.com/r/ZzuGnprE5ceard799251
		showResult(rawResult.getBarcodeFormat()
				.toString(),rawResult.getText(),barcode);
...
//		CaptureActivity.this.finish();
	...
	private void showResult(String rawResultType, final String rawResult, Bitmap barcode) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		Drawable drawable = new BitmapDrawable(barcode);
		builder.setIcon(drawable);
		builder.setTitle("类型:" + rawResultType + "\n 结果：" + rawResult);
